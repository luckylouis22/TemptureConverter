...
class Converter:
    ...
    def Fcalculuate(self):
        centiConvert = (int(self.entry1.get()) * (9 / 5)) + 32
        self.label_text3.configure(text=centiConvert)

    def Ccalculuate(self):
        centiConvert = (int(self.entry2.get()) - 32) * (5 / 9)
        self.label_text4.configure(text=centiConvert)
